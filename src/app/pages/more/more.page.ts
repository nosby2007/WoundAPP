    ...
    <ion-content>
      <div class="page">
        <section class="profile-card">
          <div class="identity"><div class="avatar">{{ initials }}</div><div><p class="eyebrow">CLINICAL ACCOUNT</p><h1>{{ displayName }}</h1><p>{{ email }}</p></div></div>
